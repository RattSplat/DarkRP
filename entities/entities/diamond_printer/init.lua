...
function ENT:Destruct()
	...
	Notify(self.dt.owning_ent, 1, 4, "Your Diamond Printer has exploded!")
end
...
function ENT:BurstIntoFlames()
	if self.Cooler and self.Cooler:GetNWInt("charges") > 0 then
		...
		Notify(self.dt.owning_ent, 0, 4, "Your Diamond Printer is overheating!")
		self.burningup = true
...
function ENT:CreateMoneybag()
	...
	self.sparking = false
	timer.Simple(math.random(250, 450), PrintMore, self)
end
